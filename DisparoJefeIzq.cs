...
public class DisparoJefeIzq : MonoBehaviour
{
    ...
    void ataqueJefeI()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(transform.position, Vector2.left, distanciaDisparo); //Creamos el metodo por el eje derecho de x
