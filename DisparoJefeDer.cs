...
public class DisparoJefeDer : MonoBehaviour
{ //Atributos para el editor
    ...
    void ataqueJefeD()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(transform.position, Vector2.right, distanciaDisparo); //Creamos el metodo por el eje derecho de x
