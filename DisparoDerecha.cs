...
public class DisparoDerecha : MonoBehaviour
{
    ...
    void disparo()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(transform.position, Vector2.right, distanciaDisparo); //Creamos el metodo raycasht pra el eje x por la derecha
